...
void drawDump(int z){
    ...
    for(int i=1; i<5;i++,pos += 10){
        ...
        case 1: dump.type = PLASTIC;drawTrashBin(1.0f, 0.0f, 0.0f, "plastic", dump.x, dump.z); break; //Plástico - Vermelho
        case 2: dump.type = PAPER;drawTrashBin(0.0f, 0.0f, 1.0f, "paper", dump.x, dump.z); break; //Papel - Azul
...
void drawTrashBin(float r, float g, float b, const char* label, float x, float z) {
    ...
    // Usar glColor3f para definir a cor, já que GL_COLOR_MATERIAL está ativado
    glColor3f(r, g, b);
    ...
    // Configurar cor preta para símbolos e texto
    ...
    // Restaurar cor branca para outros objetos
